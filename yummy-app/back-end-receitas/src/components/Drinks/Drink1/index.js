...
export default function Drink1({navigation}) {
  ...
  const Avaliacao = () => { 
    ...
    return(
      ...
      <View>
        <Text style={styles.cabecalho}>Blue Hawaiian</Text>
      </View>
        <View style={styles.foto}> 
          <Image style={styles.fotinha} source={require('../../../../assets/blue.png')} ></Image>
        </View>
...
1- Bata todos os ingredientes no liquidificador com 1 ou 2 pás de gelo até adquirir uma textura cremosa {'\n'}
2- Coe para um copo Highball de modo que apenas pequenos pedaços de gelo passem para o copo 
          </Text>
</View>
