...
export default function Drink2({navigation}) {
  ...
  const Avaliacao = () => { 
    ...
    return(
      ...
      <View>
        <Text style={styles.cabecalho}>Piña Colada</Text>
      </View>
        <View style={styles.foto}> 
          <Image style={styles.fotinha} source={require('../../../../assets/pina.png')} ></Image>
        </View>
...
1- Bata os três primeiros ingredientes no liquidificador com 1 ou 2 pás de gelo, até obter uma textura cremosa {'\n'}
2- Coe para um copo Hurricane {'\n'}
3- Decore com a Cereja e o Abacaxi
          </Text>
</View>
