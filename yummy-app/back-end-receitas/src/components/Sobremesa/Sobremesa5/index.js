...
export default function Sobremesa5({navigation}) {
  ...
  const Avaliacao = () => { 
    ...
    return(
      ...
      <View>
        <Text style={styles.cabecalho}>Ambrosia</Text>
      </View>
        <View style={styles.foto}> 
          <Image style={styles.fotinha} source={require('../../../../assets/ambrosia.png')} ></Image>
        </View>
